...
const MobileNav = ({ isMenuActive, toggleMenu }) => {
    ...
    useEffect(() => {
        ...
        if (path === '/admin' || path.includes('/admin/dashboard')) {
         ...
         else if (path.includes('/admin/add_banner')) {
          setMenu('banners');
        }
         else if (path.includes('/admin/edit_banner')) {
          setMenu('banners');
        }
         else if (path.includes('/admin/team')) {
          setMenu('team');
        }
         else if (path.includes('/admin/edit_team')) {
          setMenu('team');
        }
         else if (path.includes('/admin/add_team')) {
          setMenu('team');
        }
         else if (path.includes('/admin/testimonial')) {
          setMenu('testimonial');
        }
         else if (path.includes('/admin/edit_testimonial')) {
          setMenu('testimonial');
        }
         else if (path.includes('/admin/add_testimonial')) {
          setMenu('testimonial');
        }
         else if (path.includes('/admin/events')) {
          setMenu('events');
        }
         else if (path.includes('/admin/add_events')) {
          setMenu('events');
        }
         else if (path.includes('/admin/edit_events')) {
          setMenu('events');
        }
         ...
         else if (path.includes('/admin/notice')) {
          setMenu('notice');
        }
         else if (path.includes('/admin/add_notice')) {
          setMenu('notice');
        }
         else if (path.includes('/admin/edit_notice')) {
          setMenu('notice');
        }       
      }, [location.pathname]);
  return (
    <div className={`moobile_nav ${isMenuActive ? 'moobile_navActive' : ''} `} >
          ...
          <div className='menu'>
            <nav>
              <ul>
                <Link to="/admin">
                  <li onClick={() => { toggleMenu(); setMenu("dashboard"); }} className={menu === "dashboard" ? "liActive" : "" }>
                    <span>
                ...
                <Link to='banner'>
                  <li onClick={() => { toggleMenu(); setMenu("banners"); }} className={menu === "banners" ? "liActive" : "" } >
                    <span>
                ...
                <Link to='contact'>
                  <li onClick={() =>{toggleMenu();  setMenu("contact")}} className={menu === "contact" ? "liActive" : ""}>
                    <span>
                      <svg height="25" viewBox="0 0 48 48" width="25" xmlns="http://www.w3.org/2000/svg">
                        <path d="M38 14h-16v12h16v-12zm4-8h-36c-2.21 0-4 1.79-4 4v28c0 2.21 1.79 3.96 4 3.96h36c2.21 0 4-1.76 4-3.96v-28c0-2.21-1.79-4-4-4zm0 32.03h-36v-28.06h36v28.06z"/>
                        <path d="M0 0h48v48h-48z" fill="none"/>
                ...
                <Link to='notice'>
                  <li onClick={() => { toggleMenu(); setMenu("notice")}} className={menu === "notice" ? "liActive" : ""}>
                    <span>
                      <svg height="25" viewBox="0 0 48 48" width="25" xmlns="http://www.w3.org/2000/svg">
                        <path d="M38 14h-16v12h16v-12zm4-8h-36c-2.21 0-4 1.79-4 4v28c0 2.21 1.79 3.96 4 3.96h36c2.21 0 4-1.76 4-3.96v-28c0-2.21-1.79-4-4-4zm0 32.03h-36v-28.06h36v28.06z"/>
                        <path d="M0 0h48v48h-48z" fill="none"/>
                ...
                <Link to='events'>
                  <li onClick={() => {toggleMenu(); setMenu("events")}} className={menu === "events" ? "liActive" : ""}>
                    <span>
                      <svg height="25" viewBox="0 0 48 48" width="25" xmlns="http://www.w3.org/2000/svg">
                        <path d="M38 14h-16v12h16v-12zm4-8h-36c-2.21 0-4 1.79-4 4v28c0 2.21 1.79 3.96 4 3.96h36c2.21 0 4-1.76 4-3.96v-28c0-2.21-1.79-4-4-4zm0 32.03h-36v-28.06h36v28.06z"/>
                        <path d="M0 0h48v48h-48z" fill="none"/>
                ...
                <Link to='team'>
                  <li onClick={() => { toggleMenu(); setMenu("team"); }} className={menu === "team" ? "liActive" : "" } >
                    <span>
                      <svg height="25" viewBox="0 0 48 48" width="25" xmlns="http://www.w3.org/2000/svg">
                        <path d="M38 14h-16v12h16v-12zm4-8h-36c-2.21 0-4 1.79-4 4v28c0 2.21 1.79 3.96 4 3.96h36c2.21 0 4-1.76 4-3.96v-28c0-2.21-1.79-4-4-4zm0 32.03h-36v-28.06h36v28.06z"/>
                        <path d="M0 0h48v48h-48z" fill="none"/>
                ...
                <Link to="userList">
                  <li onClick={() => {toggleMenu();setMenu("userList")}} className={menu === "userList" ? "liActive" : "" }>
                    <span>
